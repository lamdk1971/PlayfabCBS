...
namespace CBS
{
    public class ClanEconomyModule : BaseAzureModule
    {
        ...
        [Function(AzureFunctions.GetClanInventoryMethod)]
        public static async Task<dynamic> GetClanInventoryTrigger([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)] HttpRequestData req)
        {
        ...
        [Function(AzureFunctions.GrantItemsToClanMethod)]
        public static async Task<dynamic> GrantItemsToClanTrigger([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)] HttpRequestData req)
        {
            var context = JsonConvert.DeserializeObject<FunctionExecutionContext<dynamic>>(await req.ReadAsStringAsync());
        ...
        [Function(AzureFunctions.GetClanCurrencyMethod)]
        public static async Task<dynamic> GetClanCurrencyTrigger([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)] HttpRequestData req)
        {
            var context = JsonConvert.DeserializeObject<FunctionExecutionContext<dynamic>>(await req.ReadAsStringAsync());
            var request = context.GetRequest<FunctionIDRequest>();
        ...
        [Function(AzureFunctions.AddClanCurrencyMethod)]
        public static async Task<dynamic> AddClanCurrencyTrigger([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)] HttpRequestData req)
        {
            var context = JsonConvert.DeserializeObject<FunctionExecutionContext<dynamic>>(await req.ReadAsStringAsync());
        ...
        [Function(AzureFunctions.SubtractClanCurrencyMethod)]
        public static async Task<dynamic> SubtractClanCurrencyTrigger([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)] HttpRequestData req)
        {
            var context = JsonConvert.DeserializeObject<FunctionExecutionContext<dynamic>>(await req.ReadAsStringAsync());
            var request = context.GetRequest<FunctionChangeClanCurrencyRequest>();
        ...
        [Function(AzureFunctions.TransferItemFromProfileToClanMethod)]
        public static async Task<dynamic> TransferItemFromProfileToClanTrigger([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)] HttpRequestData req)
        {
            var context = JsonConvert.DeserializeObject<FunctionExecutionContext<dynamic>>(await req.ReadAsStringAsync());
        ...
        [Function(AzureFunctions.TransferItemFromClanToProfileMethod)]
        public static async Task<dynamic> TransferItemFromClanToProfileTrigger([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)] HttpRequestData req)
        {
            var context = JsonConvert.DeserializeObject<FunctionExecutionContext<dynamic>>(await req.ReadAsStringAsync());
            var request = context.GetRequest<FunctionClanTransferItemRequest>();
