...
namespace CBS
{
    ...
    {
        [Function(AzureFunctions.CheckHealthMethod)]
        public static async Task<dynamic> CheckHealthTrigger([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)] HttpRequestData req)
        {
