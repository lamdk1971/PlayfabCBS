...
namespace CBS
{
    public class EventModule : BaseAzureModule
    {
        ...
        [Function(AzureFunctions.StartCBSEventHandlerMethod)]
        public static async Task<dynamic> StartCBSEventHandlerTrigger([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)] HttpRequestData req, [DurableClient] DurableTaskClient starter)
        {
        ...
        [Function(AzureFunctions.StopCBSEventHandlerMethod)]
        public static async Task<dynamic> StopCBSEventHandlerTrigger([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)] HttpRequestData req, [DurableClient] DurableTaskClient starter)
        {
            var context = JsonConvert.DeserializeObject<FunctionExecutionContext<dynamic>>(await req.ReadAsStringAsync());
            var request = context.GetRequest<FunctionEventProccesRequest>();
            var eventID = request.EventID;
        ...
        [Function(AzureFunctions.ExecuteCBSEventHandlerMethod)]
        public static async Task<dynamic> ExecuteCBSEventHandlerTrigger([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)] HttpRequestData req, [DurableClient] DurableTaskClient starter)
        {
            var context = JsonConvert.DeserializeObject<FunctionExecutionContext<dynamic>>(await req.ReadAsStringAsync());
            var request = context.GetRequest<FunctionEventProccesRequest>();
            var eventID = request.EventID;
        ...
        [Function(AzureQueues.StartCBSEventQueue)]
        public static async Task StartCBSEventQueue([QueueTrigger(AzureQueues.StartEventQueueName, Connection = StorageConnectionKey)] string argsString, [DurableClient] DurableTaskClient starter)
        {
        ...
        [Function(AzureQueues.StopCBSEventQueue)]
        public static async Task StopCBSEventQueue([QueueTrigger(AzureQueues.StopEventQueueName, Connection = StorageConnectionKey)] string argsString, [DurableClient] DurableTaskClient starter)
        {
            var context = JsonConvert.DeserializeObject<FunctionExecutionContext<dynamic>>(argsString);
            var args = context.FunctionArgument;
            var rawData = args == null ? JsonConvert.SerializeObject(new object{}) : JsonConvert.SerializeObject(args);
        ...
        [Function(AzureQueues.ExecuteCBSEventQueue)]
        public static async Task ExecuteCBSEventQueue([QueueTrigger(AzureQueues.ExecuteEventQueueName, Connection = StorageConnectionKey)] string argsString, [DurableClient] DurableTaskClient starter)
        {
            var context = JsonConvert.DeserializeObject<FunctionExecutionContext<dynamic>>(argsString);
            var args = context.FunctionArgument;
            var rawData = args == null ? JsonConvert.SerializeObject(new object{}) : JsonConvert.SerializeObject(args);
        ...
        [Function(AzureFunctions.GetEventQueueContainerMethod)]
        public static async Task<dynamic> GetEventQueueContainerTrigger([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)] HttpRequestData req)
        {
            var context = JsonConvert.DeserializeObject<FunctionExecutionContext<dynamic>>(await req.ReadAsStringAsync());
        ...
        [Function(AzureFunctions.GetCBSEventsMethod)]
        public static async Task<dynamic> GetCBSEventsTrigger([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)] HttpRequestData req)
        {
            var context = JsonConvert.DeserializeObject<FunctionExecutionContext<dynamic>>(await req.ReadAsStringAsync());
        ...
        [Function(AzureFunctions.GetEventBadgeMethod)]
        public static async Task<dynamic> GetEventBadgeTrigger([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)] HttpRequestData req)
        {
            var context = JsonConvert.DeserializeObject<FunctionExecutionContext<dynamic>>(await req.ReadAsStringAsync());
            var request = context.GetRequest<FunctionGetCBSEventsRequest>();
        ...
        [Function(AzureFunctions.GetCBSEventByIDMethod)]
        public static async Task<dynamic> GetCBSEventByIDTrigger([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)] HttpRequestData req)
        {
            var context = JsonConvert.DeserializeObject<FunctionExecutionContext<dynamic>>(await req.ReadAsStringAsync());
        ...
        [Function(AzureFunctions.RevokeCBSEventHandlerMethod)]
        public static async Task<dynamic> RevokeCBSEventHandlerTrigger([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)] HttpRequestData req, [DurableClient] DurableTaskClient starter)
        {
            var context = JsonConvert.DeserializeObject<FunctionExecutionContext<dynamic>>(await req.ReadAsStringAsync());
            var request = context.GetRequest<FunctionEventProccesRequest>();
            var eventID = request.EventID;
        ...
        [Function(AzureFunctions.GetCBSEventsLogListMethod)]
        public static async Task<dynamic> GetCBSEventsLogListTrigger([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)] HttpRequestData req)
        {
            var context = JsonConvert.DeserializeObject<FunctionExecutionContext<dynamic>>(await req.ReadAsStringAsync());
            var request = context.GetRequest<FunctionBaseRequest>();
        ...
        public static async Task<ExecuteResult<FunctionEmptyResult>> StartCBSEventAsync(string eventID, DurableTaskClient starter)
        {
        ...
        public static async Task<ExecuteResult<FunctionEmptyResult>> ExecuteEventTasksAsync(string eventID, DurableTaskClient starter)
        {
            var locker = new AzureBlobLeaseDistributedSynchronizationProvider(BlobContainer);
            await CreateLockContainerIfNotExistAsync();
            await using (await locker.AcquireLockAsync(TitleKeys.EventsDataKey.ToLower()))
        ...
        public static async Task<ExecuteResult<FunctionEmptyResult>> StopCBSEventAsync(string eventID, bool manual, DurableTaskClient starter)
        {
            var locker = new AzureBlobLeaseDistributedSynchronizationProvider(BlobContainer);
            await CreateLockContainerIfNotExistAsync();
            await using (await locker.AcquireLockAsync(TitleKeys.EventsDataKey.ToLower()))
        ...
        public static async Task<ExecuteResult<FunctionEmptyResult>> RevokeCBSEventAsync(string eventID, DurableTaskClient starter)
        {
            var getTaskResult = await GetFabScheduledTaskAsync(eventID);
            if (getTaskResult.Error != null)
            {
        ...
        public static void ExecuteTaskEventContainer(TaskEventContainer container, DurableTaskClient starter)
        {
            if (container == null)
                return;
            Task.Run(async ()=>
        ...
        private static async Task<ExecuteResult<dynamic>> ExecuteTasksEventContainerAsync(TaskEventContainer container, DurableTaskClient starter)
        {
