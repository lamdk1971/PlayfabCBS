...
namespace CBS
{
    public class ItemsModule : BaseAzureModule
    {
        ...
        [Function(AzureFunctions.FetchItemsMethod)]
        public static async Task<dynamic> GetProfileCurrencyTrigger([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)] HttpRequestData req)
        {
        ...
        [Function(AzureFunctions.GetItemsCategoriesMethod)]
        public static async Task<dynamic> GetItemsCategoriesTrigger([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)] HttpRequestData req)
        {
            var context = JsonConvert.DeserializeObject<FunctionExecutionContext<dynamic>>(await req.ReadAsStringAsync());
        ...
        [Function(AzureFunctions.GetFabItemsMethod)]
        public static async Task<dynamic> GetFabItemsTrigger([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)] HttpRequestData req)
        {
            var context = JsonConvert.DeserializeObject<FunctionExecutionContext<dynamic>>(await req.ReadAsStringAsync());
        ...
        [Function(AzureFunctions.GetFabItemByIDMethod)]
        public static async Task<dynamic> GetFabItemByIDTrigger([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)] HttpRequestData req)
        {
            var context = JsonConvert.DeserializeObject<FunctionExecutionContext<dynamic>>(await req.ReadAsStringAsync());
        ...
        [Function(AzureFunctions.PostPurchaseProccessMethod)]
        ...
        [Function(AzureFunctions.GrantItemsToProfileMethod)]
        public static async Task<dynamic> GrantItemsToProfileTrigger([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)] HttpRequestData req)
        {
            var context = JsonConvert.DeserializeObject<FunctionExecutionContext<dynamic>>(await req.ReadAsStringAsync());
