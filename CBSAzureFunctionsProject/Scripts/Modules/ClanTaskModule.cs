...
namespace CBS
{
    public class ClanTaskModule : BaseAzureModule
    {
        ...
        [Function(AzureFunctions.GetTasksForClanMethod)]
        public static async Task<dynamic> GetTasksForClanTrigger([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)] HttpRequestData req)
        {
        ...
        [Function(AzureFunctions.ResetClanTasksMethod)]
        public static async Task<dynamic> ResetClanTasksTrigger([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)] HttpRequestData req)
        {
            var context = JsonConvert.DeserializeObject<FunctionExecutionContext<dynamic>>(await req.ReadAsStringAsync());
            var request = context.GetRequest<FunctionClanTasksRequest>();
            var profileID = request.ProfileID;
        ...
        [Function(AzureFunctions.AddClanTaskPointsMethod)]
        public static async Task<dynamic> AddClanTaskPointsTrigger([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)] HttpRequestData req)
        {
            var context = JsonConvert.DeserializeObject<FunctionExecutionContext<dynamic>>(await req.ReadAsStringAsync());
            ...
            var getResult = await ModifyTaskPointsAsync(clanID, taskID, TaskDefaultPoolID, method, points, profileID);
            if (getResult.Error != null)
            {
                return ErrorHandler.ThrowError(getResult.Error).AsFunctionResult();
            }
        ...
        public static async Task<ExecuteResult<FunctionModifyTaskResult<CBSClanTask>>> ModifyTaskPointsAsync(string clanID, string taskID, string poolID, ModifyMethod method, int points, string profileID)
        {
