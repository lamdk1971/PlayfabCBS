...
namespace CBS
{
    public class ProfileTaskModule : BaseAzureModule
    {
        ...
        [Function(AzureFunctions.GetProfileTasksPoolMethod)]
        public static async Task<dynamic> GetProfileTasksPoolTrigger([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)] HttpRequestData req)
        {
        ...
        [Function(AzureFunctions.GetTasksForProfileMethod)]
        public static async Task<dynamic> GetTasksForProfileTrigger([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)] HttpRequestData req)
        {
            var context = JsonConvert.DeserializeObject<FunctionExecutionContext<dynamic>>(await req.ReadAsStringAsync());
            var request = context.GetRequest<FunctionProfileTasksRequest>();
        ...
        [Function(AzureFunctions.ResetProfileTasksMethod)]
        public static async Task<dynamic> ResetProfileTasksTrigger([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)] HttpRequestData req)
        {
            var context = JsonConvert.DeserializeObject<FunctionExecutionContext<dynamic>>(await req.ReadAsStringAsync());
            var request = context.GetRequest<FunctionProfileTasksRequest>();
            var profileID = request.ProfileID;
        ...
        [Function(AzureFunctions.AddProfileTaskPointsMethod)]
        public static async Task<dynamic> AddProfileTaskPointsTrigger([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)] HttpRequestData req)
        {
            var context = JsonConvert.DeserializeObject<FunctionExecutionContext<dynamic>>(await req.ReadAsStringAsync());
        ...
        [Function(AzureFunctions.AddProfileMuliplyTaskPointsMethod)]
        public static async Task<dynamic> AddProfileMuliplyTaskPointsTrigger([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)] HttpRequestData req)
        {
            var context = JsonConvert.DeserializeObject<FunctionExecutionContext<dynamic>>(await req.ReadAsStringAsync());
        ...
        [Function(AzureFunctions.PickupProfileTaskRewardMethod)]
        public static async Task<dynamic> PickupProfileTaskRewardTrigger([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)] HttpRequestData req)
        {
            var context = JsonConvert.DeserializeObject<FunctionExecutionContext<dynamic>>(await req.ReadAsStringAsync());
            var request = context.GetRequest<FunctionProfileTasksRequest>();
            var profileID = request.ProfileID;
        ...
        [Function(AzureFunctions.GetProfileTasksBadgeMethod)]
        public static async Task<dynamic> GetProfileTasksBadgeTrigger([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)] HttpRequestData req)
        {
            var context = JsonConvert.DeserializeObject<FunctionExecutionContext<dynamic>>(await req.ReadAsStringAsync());
            var request = context.GetRequest<FunctionProfileTasksRequest>();
            var profileID = request.ProfileID;
