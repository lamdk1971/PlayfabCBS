...
namespace CBS
{
    ...
    {
        [Function(AzureFunctions.GetClanLeaderboardMethod)]
        public static async Task<dynamic> GetClanLeaderboardTrigger([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)] HttpRequestData req)
        {
        ...
        [Function(AzureFunctions.GetLeaderboardAroundClanMethod)]
        public static async Task<dynamic> GetLeaderboardAroundClanTrigger([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)] HttpRequestData req)
        {
            var context = JsonConvert.DeserializeObject<FunctionExecutionContext<dynamic>>(await req.ReadAsStringAsync());
            var request = context.GetRequest<FunctionGetClanLeaderboardRequest>();
        ...
        [Function(AzureFunctions.UpdateClanStatisticMethod)]
        public static async Task<dynamic> UpdateClanStatisticTrigger([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)] HttpRequestData req)
        {
            var context = JsonConvert.DeserializeObject<FunctionExecutionContext<dynamic>>(await req.ReadAsStringAsync());
        ...
        [Function(AzureFunctions.AddClanStatisticMethod)]
        public static async Task<dynamic> AddClanStatisticTrigger([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)] HttpRequestData req)
        {
            var context = JsonConvert.DeserializeObject<FunctionExecutionContext<dynamic>>(await req.ReadAsStringAsync());
            var request = context.GetRequest<FunctionUpdateClanStatisticRequest>();
            var profileID = request.ProfileID;
