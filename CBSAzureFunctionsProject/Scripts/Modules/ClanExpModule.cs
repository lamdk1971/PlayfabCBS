...
namespace CBS
{
    public class ClanExpModule : BaseAzureModule
    {
        ...
        [Function(AzureFunctions.AddExperienceToClanMethod)]
        public static async Task<dynamic> AddExperienceToClanTrigger([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)] HttpRequestData req)
        {
        ...
        [Function(AzureFunctions.GetClanExperienceMethod)]
        public static async Task<dynamic> GetClanExpirienceDetailTrigger([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)] HttpRequestData req)
        {
            var context = JsonConvert.DeserializeObject<FunctionExecutionContext<dynamic>>(await req.ReadAsStringAsync());
