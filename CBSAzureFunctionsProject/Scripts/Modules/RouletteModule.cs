...
namespace CBS
{
    public class RouletteModule : BaseAzureModule
    {
        ...
        [Function(AzureFunctions.GetRouletteTableMethod)]
        public static async Task<dynamic> GetRouletteTableTrigger([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)] HttpRequestData req)
        {
        ...
        [Function(AzureFunctions.SpinRouletteMethod)]
        public static async Task<dynamic> SpinRouletteTrigger([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)] HttpRequestData req)
        {
            var context = JsonConvert.DeserializeObject<FunctionExecutionContext<dynamic>>(await req.ReadAsStringAsync());
            var request = context.GetRequest<FunctionBaseRequest>();
            var profileID = request.ProfileID;
