...
namespace CBS
{
    public class StoreModule : BaseAzureModule
    {
        ...
        [Function(AzureFunctions.GetAllStoresMethod)]
        public static async Task<dynamic> GetAllStoresTrigger([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)] HttpRequestData req)
        {
        ...
        [Function(AzureFunctions.GetAllStoreTitlesMethod)]
        public static async Task<dynamic> GetAllStoreTitlesTrigger([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)] HttpRequestData req)
        {
            var context = JsonConvert.DeserializeObject<FunctionExecutionContext<dynamic>>(await req.ReadAsStringAsync());
            var request = context.GetRequest<FunctionsGetStoresRequest>();
            var profileID = request.ProfileID;
        ...
        [Function(AzureFunctions.GetStoreByIDMethod)]
        public static async Task<dynamic> GetStoreByIDTrigger([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)] HttpRequestData req)
        {
            var context = JsonConvert.DeserializeObject<FunctionExecutionContext<dynamic>>(await req.ReadAsStringAsync());
        ...
        [Function(AzureFunctions.GetStoreItemByIDMethod)]
        public static async Task<dynamic> GetStoreItemByIDTrigger([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)] HttpRequestData req)
        {
            var context = JsonConvert.DeserializeObject<FunctionExecutionContext<dynamic>>(await req.ReadAsStringAsync());
            ...
            var getResult = await GetStoreItemByIDAsync(profileID, storeID, itemID, timeZone);
            if (getResult.Error != null)
            {
                return ErrorHandler.ThrowError(getResult.Error).AsFunctionResult();
            }
        ...
        [Function(AzureFunctions.PostStorePurchaseProccessMethod)]
        public static async Task<dynamic> PostStorePurchaseProccessTrigger([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)] HttpRequestData req)
        {
            var context = JsonConvert.DeserializeObject<FunctionExecutionContext<dynamic>>(await req.ReadAsStringAsync());
        ...
        [Function(AzureFunctions.PreStorePurchaseProccessMethod)]
        public static async Task<dynamic> PreStorePurchaseProccessTrigger([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)] HttpRequestData req)
        {
            var context = JsonConvert.DeserializeObject<FunctionExecutionContext<dynamic>>(await req.ReadAsStringAsync());
            var request = context.GetRequest<FunctionStoreItemRequest>();
            var profileID = request.ProfileID;
        ...
        [Function(AzureFunctions.RevokeStoreItemLimitationMethod)]
        public static async Task<dynamic> RevokeStoreItemLimitationTrigger([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)] HttpRequestData req)
        {
            var context = JsonConvert.DeserializeObject<FunctionExecutionContext<dynamic>>(await req.ReadAsStringAsync());
            var request = context.GetRequest<FunctionStoreItemRequest>();
            var profileID = request.ProfileID;
        ...
        public static async Task<ExecuteResult<CBSStoreItem>> GetStoreItemByIDAsync(string profileID, string storeID, string itemID, int timeZone)
        {
