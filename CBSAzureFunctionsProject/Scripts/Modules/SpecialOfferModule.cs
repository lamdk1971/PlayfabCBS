...
namespace CBS
{
    ...
    {
        [Function(AzureFunctions.StartSpecialOfferMethod)]
        public static async Task<dynamic> StartSpecialOfferTrigger([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)] HttpRequestData req, [DurableClient] DurableTaskClient starter)
        {
        ...
        [Function(AzureFunctions.StopSpecialOfferMethod)]
        public static async Task<dynamic> StopSpecialOfferTrigger([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)] HttpRequestData req, [DurableClient] DurableTaskClient starter)
        {
            var context = JsonConvert.DeserializeObject<FunctionExecutionContext<dynamic>>(await req.ReadAsStringAsync());
            var request = context.GetRequest<FunctionIDRequest>();
            var itemID = request.ID;
        ...
        [Function(AzureFunctions.GetSpecialOffersMethod)]
        public static async Task<dynamic> GetSpecialOffersTrigger([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)] HttpRequestData req, [DurableClient] DurableTaskClient starter)
        {
            var context = JsonConvert.DeserializeObject<FunctionExecutionContext<dynamic>>(await req.ReadAsStringAsync());
        ...
        [Function(AzureFunctions.GrantSpecialOfferToProfileMethod)]
        public static async Task<dynamic> GrantSpecialOfferToProfileTrigger([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)] HttpRequestData req, [DurableClient] DurableTaskClient starter)
        {
            var context = JsonConvert.DeserializeObject<FunctionExecutionContext<dynamic>>(await req.ReadAsStringAsync());
            var request = context.GetRequest<FunctionIDRequest>();
            var profileID = request.ProfileID;
        ...
        public static async Task<ExecuteResult<FunctionStartOfferResult>> StartSpecialOffer(string itemID, DurableTaskClient starter)
        {
            // get offer store
        ...
        public static async Task<ExecuteResult<FunctionStopOfferResult>> StopSpecialOffer(string itemID, DurableTaskClient starter)
        {
            // get offer store
            var storeRequest = new GetStoreItemsServerRequest
            {
