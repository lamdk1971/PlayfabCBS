...
namespace CBS
{
    ...
    {
        [Function(AzureFunctions.GetMatchmakingQueueMethod)]
        public static async Task<dynamic> GetMatchmakingQueueTrigger([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)] HttpRequestData req)
        {
        ...
        [Function(AzureFunctions.GetMatchmakingListMethod)]
        public static async Task<dynamic> GetMatchmakingListTrigger([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)] HttpRequestData req)
        {
            var context = JsonConvert.DeserializeObject<FunctionExecutionContext<dynamic>>(await req.ReadAsStringAsync());
            var request = context.GetRequest<FunctionMatchmakingQueueRequest>();
        ...
        [Function(AzureFunctions.UpdateMatchmakingQueueMethod)]
        public static async Task<dynamic> UpdateMatchmakingQueueTrigger([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)] HttpRequestData req)
        {
            var context = JsonConvert.DeserializeObject<FunctionExecutionContext<dynamic>>(await req.ReadAsStringAsync());
            var request = context.GetRequest<FunctionMatchmakingQueueRequest>();
            var queue = request.Queue;
        ...
        [Function(AzureFunctions.RemoveMatchmakingQueueMethod)]
        public static async Task<dynamic> RemoveMatchmakingQueueTrigger([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)] HttpRequestData req)
        {
            var context = JsonConvert.DeserializeObject<FunctionExecutionContext<dynamic>>(await req.ReadAsStringAsync());
            var request = context.GetRequest<FunctionMatchmakingQueueRequest>();
            var queue = request.Queue;
        ...
        [Function(AzureFunctions.GetMatchMethod)]
        public static async Task<dynamic> GetMatchTrigger([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)] HttpRequestData req)
        {
            var context = JsonConvert.DeserializeObject<FunctionExecutionContext<dynamic>>(await req.ReadAsStringAsync());
