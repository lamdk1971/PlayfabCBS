...
namespace CBS
{
    ...
    {
        [Function(AzureFunctions.GetRecipeDependencyStateMethod)]
        public static async Task<dynamic> GetRecipeDependencyStateTrigger([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)] HttpRequestData req)
        {
        ...
        [Function(AzureFunctions.CraftItemFromRecipeMethod)]
        public static async Task<dynamic> CraftItemFromRecipeTrigger([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)] HttpRequestData req)
        {
            var context = JsonConvert.DeserializeObject<FunctionExecutionContext<dynamic>>(await req.ReadAsStringAsync());
            var request = context.GetRequest<FunctionIDRequest>();
        ...
        [Function(AzureFunctions.CraftItemWithoutRecipeMethod)]
        public static async Task<dynamic> CraftItemWithoutRecipeTrigger([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)] HttpRequestData req)
        {
            var context = JsonConvert.DeserializeObject<FunctionExecutionContext<dynamic>>(await req.ReadAsStringAsync());
            var request = context.GetRequest<FunctionIDRequest>();
            var profileID = request.ProfileID;
        ...
        [Function(AzureFunctions.GetItemNextUpgradeStateMethod)]
        public static async Task<dynamic> GetItemNextUpgradeStateTrigger([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)] HttpRequestData req)
        {
            var context = JsonConvert.DeserializeObject<FunctionExecutionContext<dynamic>>(await req.ReadAsStringAsync());
            var request = context.GetRequest<FunctionIDRequest>();
            var profileID = request.ProfileID;
        ...
        [Function(AzureFunctions.UpgradeItemWithNextStateMethod)]
        public static async Task<dynamic> UpgradeItemWithNextStateTrigger([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)] HttpRequestData req)
        {
            var context = JsonConvert.DeserializeObject<FunctionExecutionContext<dynamic>>(await req.ReadAsStringAsync());
            var request = context.GetRequest<FunctionIDRequest>();
            var profileID = request.ProfileID;
