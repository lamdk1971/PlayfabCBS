...
namespace CBS
{
    ...
    {
        [Function(AzureFunctions.GetLeaderboardMethod)]
        public static async Task<dynamic> GetLeaderboardTrigger([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)] HttpRequestData req)
        {
        ...
        [Function(AzureFunctions.GetLeaderboardAroundProfileMethod)]
        public static async Task<dynamic> GetLeaderboardAroundProfileTrigger([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)] HttpRequestData req)
        {
            var context = JsonConvert.DeserializeObject<FunctionExecutionContext<dynamic>>(await req.ReadAsStringAsync());
            var request = context.GetRequest<FunctionGetLeaderboardRequest>();
        ...
        [Function(AzureFunctions.GetFriendsLeaderboardMethod)]
        public static async Task<dynamic> GetFriendsLeaderboardTrigger([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)] HttpRequestData req)
        {
            var context = JsonConvert.DeserializeObject<FunctionExecutionContext<dynamic>>(await req.ReadAsStringAsync());
            var request = context.GetRequest<FunctionGetLeaderboardRequest>();
        ...
        [Function(AzureFunctions.UpdateStatisticMethod)]
        public static async Task<dynamic> UpdateStatisticTrigger([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)] HttpRequestData req)
        {
            var context = JsonConvert.DeserializeObject<FunctionExecutionContext<dynamic>>(await req.ReadAsStringAsync());
        ...
        [Function(AzureFunctions.AddStatisticMethod)]
        public static async Task<dynamic> AddStatisticTrigger([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)] HttpRequestData req)
        {
            var context = JsonConvert.DeserializeObject<FunctionExecutionContext<dynamic>>(await req.ReadAsStringAsync());
            var request = context.GetRequest<FunctionUpdateStatisticRequest>();
            var profileID = request.ProfileID;
        ...
        [Function(AzureFunctions.ResetProfileStatisticsMethod)]
        public static async Task<dynamic> ResetProfileStatisticsTrigger([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)] HttpRequestData req)
        {
            var context = JsonConvert.DeserializeObject<FunctionExecutionContext<dynamic>>(await req.ReadAsStringAsync());
