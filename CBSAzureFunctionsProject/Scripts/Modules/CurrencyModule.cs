...
namespace CBS
{
    public class CurrencyModule : BaseAzureModule
    {
        ...
        [Function(AzureFunctions.GetProfileCurrencyMethod)]
        ...
        [Function(AzureFunctions.AddProfileCurrencyMethod)]
        public static async Task<dynamic> AddProfileCurrencyMethodTrigger([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)] HttpRequestData req)
        {
            var context = JsonConvert.DeserializeObject<FunctionExecutionContext<dynamic>>(await req.ReadAsStringAsync());
        ...
        [Function(AzureFunctions.SubtractProfileCurrencyMethod)]
        public static async Task<dynamic> SubtractProfileCurrencyMethodTrigger([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)] HttpRequestData req)
        {
            var context = JsonConvert.DeserializeObject<FunctionExecutionContext<dynamic>>(await req.ReadAsStringAsync());
            var request = context.GetRequest<FunctionChangeCurrencyRequest>();
        ...
        [Function(AzureFunctions.GetCurrenciesPackMethod)]
        public static async Task<dynamic> GetCurrenciesPackTrigger([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)] HttpRequestData req)
        {
            var context = JsonConvert.DeserializeObject<FunctionExecutionContext<dynamic>>(await req.ReadAsStringAsync());
        ...
        [Function(AzureFunctions.GrantCurrencyPackMethod)]
        public static async Task<dynamic> GrantCurrencyPackTrigger([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)] HttpRequestData req)
        {
            var context = JsonConvert.DeserializeObject<FunctionExecutionContext<dynamic>>(await req.ReadAsStringAsync());
