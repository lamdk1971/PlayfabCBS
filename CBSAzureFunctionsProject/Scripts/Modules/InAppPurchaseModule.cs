...
namespace CBS
{
    ...
    {
        [Function(AzureFunctions.ValidateIAPPurchaseMethod)]
        public static async Task<dynamic> ValidateIAPPurchaseTrigger([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)] HttpRequestData req)
        {
        ...
        [Function(AzureFunctions.PostIAPProcessMethod)]
        public static async Task<dynamic> PostIAPProcessTrigger([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)] HttpRequestData req)
        {
            var context = JsonConvert.DeserializeObject<FunctionExecutionContext<dynamic>>(await req.ReadAsStringAsync());
