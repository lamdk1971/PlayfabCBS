...
namespace CBS
{
    ...
    {
        [Function(AzureFunctions.GetTitleDataByKeyMethod)]
        public static async Task<dynamic> GetTitleDataByKeyTrigger([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)] HttpRequestData req)
        {
        ...
        [Function(AzureFunctions.GetAllTitleDataMethod)]
        public static async Task<dynamic> GetAllTitleDataTrigger([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)] HttpRequestData req)
        {
            var context = JsonConvert.DeserializeObject<FunctionExecutionContext<dynamic>>(await req.ReadAsStringAsync());
